...
contract KBMarket is ReentrancyGuard {
    ...
    /* number of items minting, number of transactions, token that have not been sold
     ...
     // determine who is the owner ot the contract
    ...
    // tow functions to ionteract with contract
    ...
    public payable nonReentrant {
        // nonReentrant is a modifier to prevent reentry 
    ...
    // return the number of the unsold items
    ...
    function fetchMarketTokens() public view returns(MarketToken[] memory) {
        ...
        function fetchMyNFTs() public view returns (MarketToken[] memory) {
            ...
            // second loops to loop through the amount you have purchased with itemcount
