...
// we want to load the users nfts and dsiplay
...
export default function MyAssets() {
  ...
  className='px-20 py-7 text-4x1'>You have not own any NFTs currently :(</h1>)
              ...
              <div key={i} className='border shadow rounded-x1 overflow-hidden'>
                ...
                <div className='p-4'>
                  ...
                  <div className='p-4 bg-black'>
                    <p className='text-3x1 mb-4 font-bold text-white'>{nft.price} ETH</p>
                    </div>
              </div>
            ))
          }
